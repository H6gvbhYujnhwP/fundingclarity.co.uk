        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
            ...
            <SectionReveal>
              {!submitted ? (
                <div>
                  <h2 className="text-2xl font-bold mb-2 text-dark" style={{ fontFamily: "var(--font-display)" }}>
                    Request a Quote
                  </h2>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                      <label className="block text-sm text-dark/70 mb-2" style={{ fontFamily: "var(--font-display)" }}>
                        Your name *
                      </label>
                      <input
                        type="text"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full bg-white border border-dark/15 rounded-sm px-4 py-3 text-dark placeholder:text-dark/30 focus:border-gold focus:outline-none transition-colors resize-none shadow-sm"
                ...
                <div className="bg-white border border-dark/10 shadow-lg p-10 lg:p-16 rounded-sm text-center">
                  <div className="w-16 h-16 rounded-full bg-gold/15 flex items-center justify-center mx-auto mb-6">
                    <Mail size={28} className="text-gold" />
                  </div>
                  <h2 className="text-2xl font-bold mb-4 text-dark" style={{ fontFamily: "var(--font-display)" }}>
                    Message received.
                  </h2>
                  <p className="text-dark/60 leading-relaxed max-w-md mx-auto">
            ...
            <SectionReveal delay={0.2}>
              <div className="lg:sticky lg:top-28 space-y-10">
                {/* Quick actions */}
                <div className="bg-white border border-dark/10 shadow-sm p-8 rounded-sm">
                  <h3 className="text-lg font-semibold mb-4 text-dark" style={{ fontFamily: "var(--font-display)" }}>
                    Other ways to connect
                  </h3>
                  <div className="space-y-3">
                    <a
                      href="/quiz"
                      className="flex items-center gap-3 text-sm text-dark/60 hover:text-gold transition-colors p-3 bg-gray-50 border border-dark/5 rounded-sm"
                    >
                      <ArrowRight size={16} className="text-gold shrink-0" />
                      <div>
                        <span className="text-dark font-medium block">Take the Funding Quiz</span>
                        <span className="text-dark/40 text-xs">2 minutes. Get a personalised assessment.</span>
                      </div>
                    </a>
                    <a
                      href="/booking"
                    ...
                    >
                      <ArrowRight size={16} className="text-gold shrink-0" />
                      <div>
                        <span className="text-dark font-medium block">Book a Clarity Call</span>
                        <span className="text-dark/40 text-xs">15 minutes. Free. No obligation.</span>
                      </div>
                    </a>
                    <a
                      href="/guide"
                    ...
                    >
                      <ArrowRight size={16} className="text-gold shrink-0" />
                      <div>
                        <span className="text-dark font-medium block">Download the Free Guide</span>
                        <span className="text-dark/40 text-xs">The 4 questions every founder should answer.</span>
                      </div>
                    </a>
                  </div>
                </div>
                ...
                <div className="bg-white border border-dark/10 shadow-sm p-8 rounded-sm">
                  ...
                  <div className="space-y-3">
                    <a
                      ...
                      className="flex items-center gap-3 text-sm text-dark/50 hover:text-gold transition-colors"
                    >
                      <span className="w-8 h-8 rounded-sm bg-gray-100 flex items-center justify-center">
                        <span className="text-xs font-bold text-dark" style={{ fontFamily: "var(--font-mono)" }}>Li</span>
                      </span>
                      LinkedIn
                    </a>
                    <a
                    ...
                    >
                      <span className="w-8 h-8 rounded-sm bg-gray-100 flex items-center justify-center">
                        <span className="text-xs font-bold text-dark" style={{ fontFamily: "var(--font-mono)" }}>X</span>
                      </span>
                      X (Twitter)
                    </a>
                  </div>
                ...
                <div className="border-t border-dark/10 pt-8">
                  <p className="text-dark/40 text-sm italic" style={{ fontFamily: "var(--font-body)" }}>
