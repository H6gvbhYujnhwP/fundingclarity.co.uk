      ...
      <div className="min-h-screen pt-20 lg:pt-24">
        <section className="section-gold py-24 lg:py-36">
          <div className="container">
            ...
            >
              <CheckCircle size={56} className="text-dark mx-auto mb-6" />
              <h1
                className="text-4xl sm:text-5xl font-bold mb-4 text-dark"
              ...
              <p className="text-lg text-dark/70 leading-relaxed mb-8">
                ...
                sooner, email{" "}
                <a href="mailto:hello@fundingclarity.co.uk" className="text-dark font-semibold underline hover:no-underline transition-colors">
                  hello@fundingclarity.co.uk
                </a>
              </p>
              <a
                href="/"
                className="inline-flex items-center gap-2 text-dark font-semibold hover:opacity-70 transition-colors"
                style={{ fontFamily: "var(--font-display)" }}
              >
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto">
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                <h3
                  className="text-lg font-semibold mb-4 text-dark flex items-center gap-2"
                  style={{ fontFamily: "var(--font-display)" }}
                >
                  Your Details
                </h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="text-sm text-dark/70 mb-1 block">Phone</label>
                    <input
                      type="tel"
                    ...
                    <button
                      ...
                      className={`p-3 rounded-sm text-center text-sm transition-all duration-200 ${
                        formData.preferredDate === day
                          ? "bg-gold/20 border border-gold text-dark font-semibold"
                          : "bg-white border border-dark/10 text-dark/60 hover:border-gold/40 hover:text-dark shadow-sm"
                      }`}
                    >
                      {formatDate(day)}
                    </button>
              ...
              {/* Message */}
              <div>
                <label className="text-sm text-dark/70 mb-1 block">
